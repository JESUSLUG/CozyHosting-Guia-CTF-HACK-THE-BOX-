...
6. [Inyección de Cookies](#InyeccióndeCookies)
7. [Burp Suite](#BurpSuite)
8. [Inyección de Shell o Shell Reverso](#InyeccióndeShelloShellReverso)
9. [Cloudhosting.jar y Unzip](#Cloudhosting.jaryUnzip)
10. [PostgreSQL](#PostgreSQL)
11. [Hashcat](#Hashcat)
12. [ ParteFinal y  ProxyCommand](#ParteFinal)
